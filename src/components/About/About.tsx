        ...
        >
          ...
          <div className="order-1">
            ...
            {isAboutExpanded && (
              <>
                <p className="text-gray-700 mb-8 leading-loose">
                  Our customized, high-impact offerings cater to a wide range of
                  industries and client needs, delivering innovative solutions
          ...
          <div className="pt-8 pb-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 font-semibold">
                As we enter our second year in <span className="font-bold">August 2025</span>, we're focused on:
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              {[
                { icon: Globe, title: "Expanding globally", desc: "across North America, Europe, the Middle East, and Southeast Asia.", color: "from-blue-500 to-cyan-500", bgColor: "from-blue-50 to-cyan-50" },
                { icon: Cpu, title: "Advancing AI platforms", desc: "with real-time model feedback, smarter data labeling, and AI-driven quality assurance.", color: "from-purple-500 to-indigo-500", bgColor: "from-purple-50 to-indigo-50" },
                { icon: PhoneCall, title: "Scaling BPO services", desc: "with multilingual AI-powered support teams.", color: "from-green-500 to-emerald-500", bgColor: "from-green-50 to-emerald-50" },
                { icon: Globe2, title: "Optimizing import-export", desc: "through AI-enabled logistics and compliance automation.", color: "from-orange-500 to-red-500", bgColor: "from-orange-50 to-red-50" },
                { icon: Users, title: "Revolutionizing recruitment", desc: "with predictive hiring tools and a global talent marketplace.", color: "from-pink-500 to-rose-500", bgColor: "from-pink-50 to-rose-50" },
                { icon: Lightbulb, title: "Driving sustainable impact", desc: "by adopting green tech, creating jobs in underserved regions, and supporting digital literacy.", color: "from-yellow-500 to-amber-500", bgColor: "from-yellow-50 to-amber-50" }
              ].map((item, index) => (
                <div key={index} 
                  ...
                  <div className="relative z-10 flex items-start space-x-4">
                    <div className={`flex-shrink-0 bg-gradient-to-r ${item.color} p-3 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="pt-8 pb-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                The principles that guide everything we do at Createishwari Solutions
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                { title: "Quality Above All", desc: "Impeccable data and top-tier talent, every time.", gradient: "from-blue-400 to-blue-600", bg: "from-blue-50 to-indigo-50", icon: Award },
                { title: "Integrity & Transparency", desc: "Honest, ethical practices in all we do.", gradient: "from-green-400 to-emerald-600", bg: "from-green-50 to-emerald-50", icon: Heart },
                { title: "Innovation & Growth", desc: "Continuously pushing technological boundaries.", gradient: "from-purple-400 to-violet-600", bg: "from-purple-50 to-violet-50", icon: Zap },
                { title: "Customer-Centric Approach", desc: "Tailoring solutions to each client's unique needs.", gradient: "from-orange-400 to-amber-600", bg: "from-orange-50 to-amber-50", icon: Target },
                { title: "Collaboration & Respect", desc: "Valuing diversity, teamwork, and empathy.", gradient: "from-rose-400 to-pink-600", bg: "from-rose-50 to-pink-50", icon: Users },
                { title: "Global Mindset", desc: "Operating beyond borders with cultural intelligence.", gradient: "from-teal-400 to-cyan-600", bg: "from-teal-50 to-cyan-50", icon: Globe },
                { title: "Accountability & Excellence", desc: "Delivering results with professionalism.", gradient: "from-indigo-400 to-blue-600", bg: "from-indigo-50 to-blue-50", icon: Star }
              ].map((value, index) => (
                <div key={index}
                     className={`group relative bg-gradient-to-br ${value.bg} p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 cursor-pointer border-2 border-transparent hover:border-white ${index === 6 ? 'md:col-span-2 lg:col-span-1' : ''}`}
                     onMouseEnter={() => setHoveredValue(index)}
                     onMouseLeave={() => setHoveredValue(null)}>
                  
                  {/* Animated background overlay */}
                  <div className={`absolute inset-0 bg-gradient-to-r ${value.gradient} rounded-2xl opacity-0 group-hover:opacity-15 transition-opacity duration-300`}></div>
                  
                  <div className="relative z-10">
                    {/* Icon */}
                    <div className={`inline-flex bg-gradient-to-r ${value.gradient} p-3 rounded-xl shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300`}>
